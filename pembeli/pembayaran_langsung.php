...
if (isset($_GET["id"])) {
    ...
    $queryProduk = mysqli_query($koneksi, "SELECT * FROM produk WHERE id_produk = '$_GET[id]'");
} else {
    header('location:dashboard_pembeli.php');
}
?>

<link rel="stylesheet" href="../assets/css/style_pembayaran.css?v=3">
<!--Konten-->
<div style="margin-top: 130px;" class="container">
    <form action="fungsi/transaksi_langsung.php" method="POST">
        <div class="row">
                    ...
                    while ($produk = mysqli_fetch_array($queryProduk)) {
                        ...
                        <div class="d-flex align-items-right my-2" onclick="location.href='detail_produk.php?id=<?php echo $produk['id_produk']; ?>'">
                            <img src="../assets/images/produk/<?php echo $produk["gambar_produk"] ?>" alt="" width="110px"
                                height="110px">
                            <input type="hidden" name="id_produk" id="" value="<?php echo $produk["id_produk"] ?>">
                            ...
                            <div>
                                ...
                                <input type="hidden" name="jumlah_produk" id="" value="<?php echo $jumlah_produk ?>">
                                <h5 style="margin-left: 10px; color: #ffc107;">Rp.
                                    <?php echo number_format($subtotal = ($produk["harga_produk"] * $jumlah_produk)); ?>
                                </h5>
                                <input type="hidden" name="subtotal" id=""
                                    value="<?php echo $subtotal = ($produk["harga_produk"] * $jumlah_produk); ?>">
            ...
            <div class="col-md-4 bayar mx-auto">
                <div class="container border rounded shadow p-4 mt-5">
                    ...
                    <button type="submit" name="submit" class="btn btn-warning btn-lg w-100" value="Kirim">Buat
                        Pesanan</button>
                </div>
            </div>
        </div>
